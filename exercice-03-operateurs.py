...
result = candies_rest + chocolates_rest
...
bonbons_result = candies_per_person + chocolates_per_person
...
print("Sur", days, "jours\n" "Alice a depensé un total de", total, "euros")
...
print("La boulangerie se trouve à environ", round(km), "km")
...
print("Le montant de la taxe est de", tax_free, "€")
...
# réponse 3.8
tax_included_price = price * (1 + tax_rate / 100)
print("Le prix, taxe incluse, est de", tax_included_price, "€")
...
# réponse 3.9
price_kilo_1 =  round((1.79 / 120) * 1000, 1)
price_kilo_2 = round((1.7 / 100 )* 1000, 1)

is_charly_right = bool(price_kilo_1 < price_kilo_2)

print("Charly avait-il raison ? :", is_charly_right)
print("(", price_kilo_1, "€ pour la première marque,", price_kilo_2, "€ pour seconde )")